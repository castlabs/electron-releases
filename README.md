# castLabs Electron v7.0.0-beta.2 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v7.0.0-beta.2/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v7.0.0-wvvmp-beta.2"
}
```

The `#v7.0.0-wvvmp-beta.2` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v7.0.0-beta.2/docs/api/session.md) (optional)
