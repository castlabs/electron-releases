# castLabs Electron v7.1.4 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v7.1.4/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v7.1.4-wvvmp"
}
```

The `#v7.1.4-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v7.1.4/docs/api/session.md) (optional)
