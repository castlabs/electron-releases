# castLabs Electron v4.0.8 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v4.0.8/README.md)
...
The `#v4.0.8-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
