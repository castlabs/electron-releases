# castLabs Electron v10.0.0-beta.19 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v10.0.0-beta.19/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v10.0.0-wvvmp-beta.19"
}
```

The `#v10.0.0-wvvmp-beta.19` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v10.0.0-beta.19/docs/api/session.md) (optional)
