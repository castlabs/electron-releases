# castLabs Electron v3.1.2 for Content Security 
...
[Electron README](https://github.com/electron/electron/blob/v3.1.2/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v3.1.2-wvvmp"
}
```

The `#v3.1.2-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
