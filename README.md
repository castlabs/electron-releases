...
[Electron README](https://github.com/electron/electron/blob/v1.8.4/README.md)
...
The `#1.8.4-vmp1010` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
