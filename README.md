# castLabs Electron v5.0.0 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v5.0.0/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v5.0.0-wvvmp"
}
```

The `#v5.0.0-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
