# castLabs Electron v9.1.1 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v9.1.1/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v9.1.1-wvvmp"
}
```

The `#v9.1.1-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v9.1.1/docs/api/session.md) (optional)
