# castLabs Electron v4.0.1 for Content Security 
...
[Electron README](https://github.com/electron/electron/blob/v4.0.1/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v4.0.1-wvvmp"
}
```

The `#v4.0.1-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
