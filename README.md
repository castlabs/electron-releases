# castLabs Electron v4.2.7 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v4.2.7/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v4.2.7-wvvmp"
}
```

The `#v4.2.7-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v4.2.7/docs/api/session.md) (optional)
