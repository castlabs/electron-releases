# castLabs Electron v6.0.0-beta.15 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v6.0.0-beta.15/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v6.0.0-wvvmp-beta.15"
}
```

The `#v6.0.0-wvvmp-beta.15` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v6.0.0-beta.15/docs/api/session.md) (optional)
