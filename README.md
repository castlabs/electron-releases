# castLabs Electron v5.0.6 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v5.0.6/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v5.0.6-wvvmp"
}
```

The `#v5.0.6-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v5.0.6/docs/api/session.md) (optional)
