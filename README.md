# castLabs Electron v9.0.0-beta.4 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v9.0.0-beta.4/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v9.0.0-wvvmp-beta.4"
}
```

The `#v9.0.0-wvvmp-beta.4` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v9.0.0-beta.4/docs/api/session.md) (optional)
