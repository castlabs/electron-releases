# castLabs Electron v7.3.3 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v7.3.3/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v7.3.3-wvvmp"
}
```

The `#v7.3.3-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v7.3.3/docs/api/session.md) (optional)
