# castLabs Electron v9.0.0 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v9.0.0/README.md)
...
The `#v9.0.0-wvvmp` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v9.0.0/docs/api/session.md) (optional)
