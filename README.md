# castLabs Electron v10.0.0-beta.3 for Content Security
...
[Electron README](https://github.com/electron/electron/blob/v10.0.0-beta.3/README.md)
...
```
"dependencies": {
  "electron": "https://github.com/castlabs/electron-releases#v10.0.0-wvvmp-beta.3"
}
```

The `#v10.0.0-wvvmp-beta.3` part of the URL references a specific release tag for Electron for Content Security, if it is left out the master branch will be tracked instead.
...
* `options` Object (optional)
  * `session` [Session](https://github.com/electron/electron/blob/v10.0.0-beta.3/docs/api/session.md) (optional)
